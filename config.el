...
;; when we run doom-emacs in flatpak we set EMACS='flatpak run org.gnu.emacs -Q',
;; but we need to revert that in order for !doom/reload to work
(when (string-match "flatpak" (getenv "EMACS"))
  (setenv "EMACS" "emacs"))
;;(setenv "EMACS" "emacs")
